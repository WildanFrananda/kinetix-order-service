...
namespace Kinetix.OrderService.Migrations {
    ...
    [Migration("20260922092625_S13OrderRemembersItsMerchant")]
    partial class S13OrderRemembersItsMerchant {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kinetix.OrderService.Domain.Entities.Order", b => {
                ...
                b.HasIndex("UpdatedAt", "OrderNumber")
            ...
            modelBuilder.Entity("Kinetix.OrderService.Domain.Entities.OrderReturn", b => {
                ...
                b.Property<DateTime?>("GoodsReceivedAt")
                    .HasColumnType("timestamp with time zone")
                ...
                b.HasIndex("MerchantPrincipalId", "Status");

                b.ToTable("order_returns");
            });

            modelBuilder.Entity("Kinetix.OrderService.Domain.Entities.OrderReturnLine", b => {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("integer")
                    .HasColumnName("id");
                ...
                b.ToTable("order_return_lines");
            });

            modelBuilder.Entity("Kinetix.OrderService.Domain.Entities.ShippingSettlement", b => {
                b.Property<string>("OrderNumber")
                    .HasMaxLength(64)
                    .HasColumnType("character varying(64)")
                    .HasColumnName("order_number");
                ...
                b.Property<string>("DriverPrincipalId")
                    .IsRequired()
                    .HasMaxLength(64)
                    .HasColumnType("character varying(64)")
                    .HasColumnName("driver_principal_id");
                ...
                b.HasIndex("SettledAt", "NextAttemptAt");

                b.ToTable("shipping_settlements");
            });
            ...
            modelBuilder.Entity("Kinetix.OrderService.Domain.Entities.OrderReturnLine", b => {
                b.HasOne("Kinetix.OrderService.Domain.Entities.OrderReturn", "Return")
                    .WithMany("Lines")
